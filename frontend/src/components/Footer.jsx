        ...
        <div className="footer-top-grid">
          ...
          <div className="footer-brand-col">
            <div className="footer-logo">
              <img src="/images/white_logo.png" alt="AS Solar System Sialkot" className="footer-logo-img logo-dark-theme" loading="lazy" decoding="async" width="150" height="45" />
              <img src="/images/black_logo.png" alt="AS Solar System Sialkot" className="footer-logo-img logo-light-theme" loading="lazy" decoding="async" width="150" height="45" />
            </div>
